        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SystemAuditLog_ActionType", "[ActionType] IN ('ADMIN_CREATED_ELECTION', 'ADMIN_STARTED_ELECTION_VOTING_PHASE', 'ADMIN_ENDED_ELECTION_VOTING_PHASE', 'ADMIN_CREATED_POLL', 'ADMIN_STARTED_POLL', 'ADMIN_ENDED_POLL')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationHash = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NominationReasons = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Votes_CandidateProfiles_CandidateProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_CandidateProfileId",
                table: "Votes",
